 ...
 * tidied.
 *
 * It says nothing about whether the sizes are the RIGHT sizes, or about weights,
 * line heights or spacing. Those are worth doing and are not done here; claiming
 * otherwise would make a passing run mean more than it does.
 *
...
async function main() {
    ...
    if (problems.length === 0) {
        console.log('  One scale. Every font size resolves to a token.\n');
